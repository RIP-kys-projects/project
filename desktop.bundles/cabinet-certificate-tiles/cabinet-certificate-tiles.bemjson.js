										...
										content: {
											...
											js: {
												...
												bemJSON: {
													...
													mods: {color: 'white-transparent', width: 'full', tiles: true},
													js: true,
													item: [
														{
															val: '05117',
															content: 'ОАО \"Объединенная авиастроительная корпорация nhjkjkjkjkjkjkjkf kjkjkj trolololol ololol lohi eti\"',
															/*mixBlock: {
														...
														{
															val: '05118',
															content: 'OOO \"Золото Транссиба i eshe neftm i almazy i td i tp trololo\"',
															selected: true,
															/*mixBlock: {
																block: 'certificate-change',
																js: true
...
/*------------------------------------------------- main content part -------------------------------------------------*/
		{
			block: 'content',
			mods: { type: 'transparent'},
			mix: { block: 'cabinet-tiles-container' },
			content: {
				elem: 'inner',
				content: [
					{
